/**
 * @module @simoko/tw-zip/svelte
 * @description Svelte Store 版本的台灣郵遞區號查詢工具
 */
...
/**
 * 建立台灣郵遞區號 Svelte Store（3碼）
 * @returns 縣市、行政區、郵遞區號的 Svelte stores
 * @example
 * ```svelte
 * <script>
 * import { createTwZip } from '@simoko/tw-zip/svelte'
 * const { cities, city, districts, zipCode, setCity } = createTwZip()
 * </script>
 * ```
 */
